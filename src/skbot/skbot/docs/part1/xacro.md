...
## usage
```
ros2 run xacro xacro <path to xacro file>
```

## launch

<details>
    <summary>using gazebo_ros spawn_entity.py</summary>

```python title="xacro launch"
import os
...
<details>
    <summary>using robot state publisher</summary>
